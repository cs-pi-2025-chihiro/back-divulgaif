...
(
    ...
    FOREIGN KEY (work_status_id) REFERENCES work_status (id) ON DELETE RESTRICT,
...
CREATE INDEX idx_works_status_id ON works(work_status_id);
CREATE INDEX idx_works_type_id ON works(work_type_id);
