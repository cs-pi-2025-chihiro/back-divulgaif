...
public class CreateUserUseCase {
    ...
    public CreateUserResponse execute(CreateUserRequest request) {
        ...
        String accessToken = jwtService.generateToken(savedUser.getId(), permissions, accessTokenExpirationTime, "access");
        String refreshToken = jwtService.generateToken(savedUser.getId(), permissions, refreshTokenExpirationTime, "refresh");

        return createUserResponse.toPresentation(accessToken, refreshToken, savedUser);
    }
    ...
    private void determineUserRole(CreateUserRequest request, User user) {
        if (Objects.equals(request.userType(), SuapConstants.TEACHER_SUAP_TYPE)) {
